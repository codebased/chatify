...
public class GCMIntentService extends GCMBaseIntentService {
	...
	private ChatifyApplication aController = null;

    public GCMIntentService() {
    	// Call extended class Constructor GCMBaseIntentService
        super(ApplicationMaster.GOOGLE_SENDER_ID);
    }
    ...
    protected void onRegistered(Context context, String registrationId) {
    	...
    	if(aController == null) { 
           aController = (ChatifyApplication) getApplicationContext();
    	}
    	
        Log.i(TAG, "Device registered: regId = " + registrationId);
        aController.displayMessageOnScreen(context, "Your device registred with GCM");
         
        aController.register(context, PreferenceDataSource.getValue(PreferenceDataSource.PHONENUMBER), registrationId);
    }
